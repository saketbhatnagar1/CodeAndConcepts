...
# --- Website Row (with Search Button) ---
website_frame = Frame(window, bg="#f5f5f5")
website_frame.grid(row=1, column=0, columnspan=3, pady=5, sticky="w")

website_label = Label(website_frame, text="Website:", bg="#f5f5f5")
website_label.grid(row=0, column=0, padx=(0,5))

website_entry = Entry(website_frame, width=30)
website_entry.grid(row=0, column=1, padx=(0,5))
website_entry.focus()

search_button = Button(website_frame, text="Search", width=12, command=find_password)
